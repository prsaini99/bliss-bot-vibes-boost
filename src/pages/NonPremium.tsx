    ...
    <PageWrapper>
      <div className="w-full max-w-4xl px-4">
        <Card className="p-6 mb-8">
          ...
          <h1 className="text-2xl font-bold mb-4">Free Plan Features</h1>
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              <h2 className="text-lg font-medium mb-3">Premium Features (Locked)</h2>
              <ul className="space-y-2 opacity-60">
                <li className="flex items-center">
                  <div className="h-2 w-2 rounded-full bg-gray-400 mr-2"></div>
                  <span>Unlimited mood assessments</span>
                </li>
                <li className="flex items-center">
                  <div className="h-2 w-2 rounded-full bg-gray-400 mr-2"></div>
                ...
                <li className="flex items-center">
                  <div className="h-2 w-2 rounded-full bg-gray-400 mr-2"></div>
                  <span>Advanced personalization algorithm</span>
                </li>
                <li className="flex items-center">
                  <div className="h-2 w-2 rounded-full bg-gray-400 mr-2"></div>
                ...
                <li className="flex items-center">
                  <div className="h-2 w-2 rounded-full bg-gray-400 mr-2"></div>
                  <span>Detailed mood analytics and trends</span>
                </li>
                <li className="flex items-center">
                  <div className="h-2 w-2 rounded-full bg-gray-400 mr-2"></div>
          ...
          <div className="bg-gradient-to-r from-bliss-teal/5 to-bliss-blue/5 rounded-lg p-6 border border-bliss-teal/20">
